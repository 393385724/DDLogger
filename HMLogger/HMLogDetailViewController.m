...
#import "HMLogDetailKeyboardToolBar.h"

@interface HMLogDetailViewController ()<UISearchBarDelegate,HMLogDetailKeyboardToolBarDelegate>

@property (weak, nonatomic) IBOutlet ICTextView *myTextView;
@property (weak, nonatomic) IBOutlet UISearchBar *searchBar;
@property (weak, nonatomic) IBOutlet UILabel *countLabel;
@property (nonatomic, strong) HMLogDetailKeyboardToolBar *toolBar;

@end

@implementation HMLogDetailViewController{
    BOOL _hasEdit;
}
...
- (void)viewDidLoad {
    ...
    //搜索操作工具条
    self.toolBar = [[HMLogDetailKeyboardToolBar alloc] initWithFrame:CGRectMake(0, 0, CGRectGetWidth(self.view.bounds), 44)];
...
- (void)updateRightBarButtonItem{
    UIImage *image = [UIImage imageNamed:@"HMLog_check_icon_normal"];
    if (self.hasPiker) {
        image = [UIImage imageNamed:@"HMLog_check_icon_selected"];
    }
...
#pragma mark - HMLogDetailKeyboardToolBarDelegate
