//
//  HMLogListTableViewController.m
//  MDLoginSDK
//
...
@implementation HMLogListTableViewController{
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([fileName.pathExtension hasPrefix:@"hms"]) {
        ...
        HMLogDetailViewController *viewController = [[HMLogDetailViewController alloc] init];
